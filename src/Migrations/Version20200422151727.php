 ...
 */
final class Version20200422151727 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__applicant AS SELECT id, user_id, name FROM applicant');
        $this->addSql('DROP TABLE applicant');
        $this->addSql('CREATE TABLE applicant (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL, CONSTRAINT FK_CAAD1019A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO applicant (id, user_id, name) SELECT id, user_id, name FROM __temp__applicant');
